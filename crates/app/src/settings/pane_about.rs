...
use super::tags::{
    COL_W, CONTENT_HEADER_H, CONTENT_PAD_X, CONTENT_W, GITHUB_URL, H, HEADER_GAP, TOP_INSET,
    card_frame, row_center_y,
};

pub(crate) fn build_about_pane(st: &Strings) -> Retained<NSView> {
